...
$(package)_config_opts=--enable-static --disable-devel-docs --without-doxygen --without-launchd
...
$(package)_config_opts += --enable-xinput --disable-xprint --disable-selinux
