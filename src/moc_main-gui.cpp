/****************************************************************************
** Meta object code from reading C++ file 'main-gui.h'
**
...
#error "The header file 'main-gui.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 7, 9), // "setScreen"
QT_MOC_LITERAL(2, 17, 0), // ""
QT_MOC_LITERAL(3, 18, 6), // "loader"
QT_MOC_LITERAL(4, 25, 7) // "qmlFile"

    },
    "System\0setScreen\0\0loader\0qmlFile"
};
...
void System::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->setScreen((*reinterpret_cast< QObject*(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        default: ;
        }
    }
}
