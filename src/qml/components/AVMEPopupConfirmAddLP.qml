...
/**
 * Popup for adding liquidity to a coin/token pool. Has to be opened manually.
...
Popup {
  ...
  function setTxData(coinAmount, coinLabel, tokenAmount, tokenLabel, gasLimit, gasPrice) {
    confirmAddLPPopup.coinAmount = coinAmount
    confirmAddLPPopup.coinLabel = coinLabel
    confirmAddLPPopup.tokenAmount = tokenAmount
    confirmAddLPPopup.tokenLabel = tokenLabel
    confirmAddLPPopup.gasLimit = gasLimit
    confirmAddLPPopup.gasPrice = gasPrice
  }
  ...
  Rectangle {
    ...
    Text {
      ...
      text: "You will add to the liquidity pool:"
    ...
    Row {
      ...
      AVMEButton {
        ...
        text: "Cancel"
        onClicked: {
          confirmAddLPPopup.clean()
          confirmAddLPPopup.close()
        }
      }
      AVMEButton {
        id: btnConfirm
